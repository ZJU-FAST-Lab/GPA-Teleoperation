...
class map_generator(object):
    ...
    def make_map(self):
        ...
        # big maze
        # self.add_box([16.0, 16.0, 0.1], [0.0, 0.0, 0.0])
        ...
        self.add_box([12, 0.5, 3.0], [1.0, 6.0, 0.5])
        self.add_box([12, 0.5, 3.0], [1.0, -9.0, 0.5])
        self.add_box([0.5, 16, 3.0], [7.0, -1.5, 0.5])
        self.add_box([0.5, 16, 3.0], [-4.75, -1.5, 0.5])

        # small maze
        # self.add_box([8.0, 0.5, 3.0], [0.0, 1.5, 0.5])
        
        # self.add_box([0.5, 6.0, 3.0], [3.0, -1.0, 0.5])

        # self.add_box([4.0, 0.5, 3.0], [0.0, -4.0, 0.5])
