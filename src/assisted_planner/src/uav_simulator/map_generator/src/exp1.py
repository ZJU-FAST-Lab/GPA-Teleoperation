...
class map_generator(object):
    ...
    def add_racing_ring(self, ring_size, position, spin):
        '''ring_size: [x, y] '''
        '''position: [x, y, z] '''
        if spin == 0:
            # up
            ...
            # up
            self.add_box([0.5 + ring_size[0], 0.25, 0.25], [position[0], position[1], position[2] + 0.125 + ring_size[1] / 2.0])
            # down
            self.add_box([0.5 + ring_size[0], 0.25, 0.25], [position[0], position[1], position[2] - 0.125 - ring_size[1] / 2.0])
            # left
            self.add_box([0.25, 0.25, 0.5 + ring_size[0]], [position[0] - 0.125 - ring_size[0] / 2.0, position[1], position[2]])
            # right
            self.add_box([0.25, 0.25, 0.5 + ring_size[0]], [position[0] + 0.125 + ring_size[0] / 2.0, position[1], position[2]])
        else:
            print("ERROR when generate map!!!")
    ...
    def make_map(self):
        ...
        # self.add_racing_ring([1.0,1.0], [5.0, 0.0, 1.0], 0)
        # self.add_racing_ring([1.0,1.0], [5.0, 2.5, 1.0], 0)
        # self.add_racing_ring([1.0,1.0], [5.0, -2.5, 1.0], 0)

        # self.add_racing_ring([1.0,1.0], [5.0, 0.0, 3.0], 0)
        # self.add_racing_ring([1.0,1.0], [5.0, 2.5, 3.0], 0)
        # self.add_racing_ring([1.0,1.0], [5.0, -2.5, 3.0], 0)
        ...
        # self.add_racing_ring([1.0,1.0], [5.0, 0.0, 2.5])


        # maze
        # self.add_box([8.0, 2.0, 3.0], [0.0, 2.0, 0.5])
        
        # self.add_box([2.0, 6.0, 3.0], [3.0, -1.0, 0.5])

        # self.add_box([4.0, 4.0, 3.0], [0.0, -4.0, 0.5])

        # self.add_box([1.0, 1.0, 3.0], [4.5, 1.5, 0.5])
        # self.add_box([1.0, 1.0, 3.0], [-0.5, -1.5, 0.5])
        # self.add_box([1.0, 1.0, 3.0], [-0.5, 0.5, 0.5])

        self.add_box([8, 0.1, 2.0], [0.0, 2.5, 0.5])
        self.add_box([6, 0.1, 2.0], [7.0, 2.5, 0.5])
        self.add_box([8, 0.1, 2.0], [0.0, -2.5, 0.5])
        self.add_box([6, 0.1, 2.0], [7.0, -2.5, 0.5])
        self.add_box([0.1, 5.1, 2.0], [10.0, 0.0, 0.5])
        self.add_box([0.1, 5.1, 2.0], [-4.0, 0.0, 0.5])


        self.add_box([0.5, 3.0, 0.8], [4.0, 0.0, -0.1])
        self.add_box([0.5, 0.3, 2.0], [4.0, 1.5, 0.5])
        self.add_box([0.5, 0.3, 2.0], [4.0, -1.5, 0.5])

        self.add_box([0.5, 2.0, 1.2], [-1.5, 0.0, 0.1])
        self.add_box([0.5, 3.0, 1.2], [0.5, 0.5, 0.1])
        self.add_box([0.5, 3.0, 1.2], [2.5, -0.5, 0.1])

        self.add_box([3.0, 0.5, 1.2], [6.0, 0.5, 0.1])
        self.add_box([0.5, 1.5, 1.2], [7.0, -0.5, 0.1])
