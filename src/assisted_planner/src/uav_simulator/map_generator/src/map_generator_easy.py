...
class map_generator(object):
    ...
    def make_map(self):
        ...
        # wall 0
        self.add_box([2.8, 3.0, 5.2], [-0.5, 2.0, 0.0])
        # self.add_box([0.8, 3.0, 5.2], [0.0, -3.0, 0.0])
        # wall 1 / 2 / 3 (door)
        # self.add_box([3.5, 0.3, 3.0], [-4.3, 1.8, 1.5])
        # self.add_box([1.0, 0.3, 3.0], [-4.3, 1.8, 1.5])
        
        # self.add_racing_ring([1.0,1.0], [0.0, 0.0, 1.5], 0)

        # self.add_racing_ring([1.0,1.0], [-10.0, 0.0, 1.0], 0)
        # self.add_racing_ring([1.0,1.0], [10.0, 0.0, 1.0], 0)

        # self.add_racing_ring([1.0,1.0], [-20.0, 0.0, 1.5], 0)
        # self.add_racing_ring([1.0,1.0], [20.0, 0.0, 1.5], 0)

        # self.add_racing_ring([1.0,1.0], [-30.0, 0.0, 1.0], 0)
        # self.add_racing_ring([1.0,1.0], [30.0, 0.0, 1.0], 0)

        # self.add_racing_ring([1.0,1.0], [-40.0, 0.0, 1.5], 0)
        # self.add_racing_ring([1.0,1.0], [40.0, 0.0, 1.5], 0)
