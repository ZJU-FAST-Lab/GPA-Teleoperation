...
namespace ego_planner
{
  ...
  public:
    ...
    // ! wxx
    void updatePlanParam( double vel );
    void updatePlanParam( Eigen::Vector3d racing_ring );
    void updateYaw( double yaw );
    void updateGoal( Eigen::Vector3d odom, Eigen::Vector3d goal );
    void updateTopoPoint( Eigen::Vector3d topo_point );

    Eigen::Vector3d racing_ring_;
    Eigen::Vector3d topo_point_;
    Eigen::Vector3d last_local_target_pt_;
